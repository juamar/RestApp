namespace RestApp.Migrations
{
    ...
    public partial class InitialModel : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        UserRequesterId = c.Int(nullable: false),
                        UserId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Users", t => t.UserId, cascadeDelete: false)
                .ForeignKey("dbo.Users", t => t.UserRequesterId, cascadeDelete: false)
                ...
                c => new
                    {
                        ...
                        IsReaded = c.Boolean(nullable: false, defaultValue: false),
                    })
                .PrimaryKey(t => t.Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.UserConversations", "UserId", "dbo.Users");
            ...
            DropForeignKey("dbo.Friendships", "UserRequesterId", "dbo.Users");
            ...
            DropIndex("dbo.Friendships", new[] { "UserRequesterId" });
